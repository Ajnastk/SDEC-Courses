  ...
  return (
    <div className="relative">
      ...
      >
        <Link
          href="/"
          className="flex items-center text-2xl text-black font-light"
        >
            ...
            {navLinks.map((item, index) =>
              item.type === "scroll" ? (
                <Link
                  key={index}
                  href={`#${item.id}`}
                  className={`py-4 text-lg transform transition-all duration-500 ${
                    item.delay
                  } ${
                    mobileMenuOpen
                ...
                <Link
                  key={index}
                  href={item.path}
                  className={`py-4 border-b-[0.2px] border-b-gray-400 text-lg transform transition-all duration-500 ${
                    item.delay
                  } ${
                    mobileMenuOpen
                      ? "translate-y-0 opacity-100"
