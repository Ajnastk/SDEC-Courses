        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-15">
          {data.cards.map((card, index) => {
            return (
              <div
                key={index}
                className="px-9 bg-gradient-to-b from-[#f5ecfa] to-[#ffffff] text-center py-16 transition-transform relative rounded-3xl flex flex-col justify-center items-center gap-5"
                style={{
