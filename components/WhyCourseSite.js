    ...
    <div className="py-16 bg-gradient-to-r from-white via-[#f6e7ff] to-white">
      <div className="max-w-7xl mx-auto flex flex-col px-6">
        ...
        <div className="text-center mb-12">
          <div className="text-black font-medium inline-flex  w-[110px] text-sm  items-center gap-1 bg-purple-50 border-2 border-gray-200  rounded-full mb-5">
          ...
          <FadeInOnScroll direction="up" delay={0.1}></FadeInOnScroll>
          <h2 className="md:text-4xl text-3xl  text-black mb-4 relative">
            But Why SDEC ?
          </h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-8 flex flex-col justify-center items-center">
                  ...
                  <div>
                    ...
                    <FadeInOnScroll direction="up" delay={0.6}>
                      <p className="text-gray-600 text-sm">
                        Receive a recognized credential that significantly
                        boosts your resume.
                      </p>
                    </FadeInOnScroll>
                  </div>
                  ...
                  <div>
                    ...
                    <FadeInOnScroll direction="up" delay={0.9}>
                      <p className="text-gray-600 text-sm">
                        Connect with peers and valuable industry professionals
                        for growth.
                      </p>
                    </FadeInOnScroll>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <FadeInOnScroll direction="up" delay={0.6}>
                      <p className="text-gray-600 text-sm mb-4">
                        in web-design and development in 2024 with a team of
                        young, passionate creators. We transitioned into a
                        full-time training and mentorship collective in 2025.
                      </p>
                    </FadeInOnScroll>
                    <FadeInOnScroll direction="up" delay={0.7}>
                      ...
                      <p className="text-gray-600 text-sm mb-6">
                        project-based courses, our team simplifies challenging
                        topics and makes them accessible to everyone.
                      </p>
                    </FadeInOnScroll>
                  </div>
                ...
                <div className="space-y-8 flex flex-col justify-center items-center">
                  ...
                  <div>
                    ...
                    <FadeInOnScroll direction="up" delay={0.6}>
                      <p className="text-gray-600 text-sm">
                        Master essential topics and practical skills effectively
                        and thoroughly.
                      </p>
                    </FadeInOnScroll>
                  </div>
