      ...
      <div className=" relative w-full flex md:flex-row flex-col ">
        <div className="md:w-[50%] w-full md:pl-40 pl-2 z-10">
          ...
          <div className="space-y-6">
            ...
            <button
              className={`relative overflow-hidden w-[35%] h-[45px] py-1 px-4 rounded-full text-md transition-colors cursor-pointer group bg-gradient-to-br from-[#7f7e80] to-black text-white `}
            >
